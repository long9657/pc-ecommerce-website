      ...
      <section className='bg-slate-50 py-16 md:py-5 px-5'>
        <div className='container mx-auto max-w-7xl'>
          <div className='flex flex-col md:flex-row items-start justify-center gap-12 md:gap-16'>
            <Link to='/faq' className='flex-1 flex flex-col items-center text-center p-5 hover:opacity-80 transition no-underline text-inherit'>
            ...
            <Link to='/profile' className='flex-1 flex flex-col items-center text-center text-xs p-5 hover:opacity-80 transition no-underline text-inherit'>
              <div className='flex h-15 w-15 items-center justify-center rounded-full bg-blue-600 text-white mb-6'>
                <svg className='h-10 w-10' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
            ...
            <Link to='/products' className='flex-1 flex flex-col items-center text-center p-5 hover:opacity-80 transition no-underline text-inherit'>
              <div className='flex h-15 w-15 items-center justify-center rounded-full bg-blue-600 text-white mb-6'>
                <svg className='h-10 w-10' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
